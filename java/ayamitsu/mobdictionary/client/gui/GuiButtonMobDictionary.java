...
/**
 * Created by ayamitsu0321 on 2015/08/12.
 */
public class GuiButtonMobDictionary extends GuiButton {

    protected static final ResourceLocation buttonTexture = new ResourceLocation(MobDictionary.MODID, "textures/gui/button.png");

    public GuiButtonMobDictionary(int buttonId, int x, int y, String buttonText) {
